export const WWS_CONFIG = {
	baseUrl: "https://www.woolworths.com.au",
	endpoints: {
		category: "/shop/browse",
		product: "/shop/productdetails",
		api: "/apis/ui/browse/category",
	},
	defaultPageSize: 36, // Woolworths returns 36 products per page if the resolution is 1920x1080
	cookies: {
	...
	categories: [
		...
		{ id: "1_B63CF9E", name: "Pet", urlFriendlyName: "pet" },
